...
public class HelloController {
    ...
    public ResponseEntity<ResponseUserRegisterDTO> getMyUserInfo(@AuthenticationPrincipal User user) {
    ...
    public ResponseEntity<ResponseUserRegisterDTO> getUserInfo(@PathVariable String username) {
